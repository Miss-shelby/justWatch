           ...
           >
            <View className="flex flex-col items-center justify-center">
                <View className="bg-red h-15 w-15 flex justify-center items-center rounded-full">
                  <Text className="text-white font-heading text-2xl">AR</Text>
                </View>
                <Text className="text-white pt-2 font-heading text-2xl">Alex Rivera</Text>
                <Text className="text-[#666] pt-2">Member since 2024 · Cinema enthusiast</Text>
                ...
                <View className="border-t border-card w-full">
                  <Text className="text-[#555] font-semibold uppercase text-sm pt-3 ">Favourite Genres</Text>
                  <View className="flex-row flex-wrap gap-x-5 gap-y-2.5 pt-5">
                    {
                      favouriteGenres.map((genre)=>{
                        ...
                        return ( 
                          ...
                          key={genre.id} className={`py-2 px-4 rounded-full border ${
                            isSelected ? 'bg-red/10 border-red/30' : 'bg-transparent border-[#333]'
                          }`}  underlayColor="transparent">
                           <Text className={`text-xs ${isSelected ? 'text-red' : 'text-gray'}`}>{genre.title}</Text>
                       </TouchableHighlight>)
                      })
                    }
                  </View>
                    ...
                    <View className="border-t mt-5 border-card w-full">
                      <Text className="text-[#555] font-semibold uppercase text-sm pt-3 ">Account</Text>
                      <View className="flex-col gap-4  pt-5">
                        <View className="flex-row gap-3 items-center">
                          ...
                          <View className="flex-row gap-3 items-center border-t pt-3 border-card ">
                           ...
                           <View className="flex-row gap-3 items-center border-t pt-3 pb-10 border-card ">
